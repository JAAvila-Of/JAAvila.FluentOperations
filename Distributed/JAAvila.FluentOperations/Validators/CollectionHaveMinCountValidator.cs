...
/// </summary>
internal class CollectionHaveMinCountValidator<T>(PrincipalChain<IEnumerable<T>> chain, int min)
    : IValidator,
        IRuleDescriptor
{
    ...
    public bool Validate()
    {
        ...
        {
            ResultValidation =
                "The collection was expected to have at least {0} elements, but it had {1}.";
            return false;
        }
