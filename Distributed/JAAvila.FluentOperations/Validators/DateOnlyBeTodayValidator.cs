...
/// </summary>
internal class DateOnlyBeTodayValidator(PrincipalChain<DateOnly> chain)
    : IValidator,
        IRuleDescriptor
{
    public static DateOnlyBeTodayValidator New(PrincipalChain<DateOnly> chain) => new(chain);
