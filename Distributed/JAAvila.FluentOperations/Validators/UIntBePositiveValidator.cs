...
/// </summary>
internal class UIntBePositiveValidator(PrincipalChain<uint> chain) : IValidator, IRuleDescriptor
{
    public static UIntBePositiveValidator New(PrincipalChain<uint> chain) => new(chain);
