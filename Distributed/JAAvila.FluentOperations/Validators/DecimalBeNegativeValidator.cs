...
/// </summary>
internal class DecimalBeNegativeValidator(PrincipalChain<decimal> chain)
    : IValidator,
        IRuleDescriptor
{
    public static DecimalBeNegativeValidator New(PrincipalChain<decimal> chain) => new(chain);
