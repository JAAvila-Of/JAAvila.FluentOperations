...
/// </summary>
internal class NullableGuidNotHaveValueValidator(PrincipalChain<Guid?> chain)
    : IValidator,
        IRuleDescriptor
{
    public static NullableGuidNotHaveValueValidator New(PrincipalChain<Guid?> chain) => new(chain);
