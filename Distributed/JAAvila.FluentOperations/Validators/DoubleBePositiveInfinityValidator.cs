...
/// </summary>
internal class DoubleBePositiveInfinityValidator(PrincipalChain<double> chain)
    : IValidator,
        IRuleDescriptor
{
    public static DoubleBePositiveInfinityValidator New(PrincipalChain<double> chain) => new(chain);
