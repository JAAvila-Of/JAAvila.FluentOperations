...
/// </summary>
internal class UShortBeGreaterThanOrEqualToValidator(PrincipalChain<ushort> chain, ushort expected)
    : IValidator,
        IRuleDescriptor
{
    public static UShortBeGreaterThanOrEqualToValidator New(
