...
/// </summary>
internal class NullableDateTimeBeSameMonthValidator(PrincipalChain<DateTime?> chain, DateTime expected) : IValidator, IRuleDescriptor
{
    public static NullableDateTimeBeSameMonthValidator New(PrincipalChain<DateTime?> chain, DateTime expected) =>
        new(chain, expected);
    ...
    public bool Validate()
    {
        ...
        ResultValidation = "The resulting value was expected to be in the same month as {0}, but {1} was found.";
        return false;
    }
