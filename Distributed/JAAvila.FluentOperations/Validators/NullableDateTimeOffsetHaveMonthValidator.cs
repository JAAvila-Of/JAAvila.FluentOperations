...
/// </summary>
internal class NullableDateTimeOffsetHaveMonthValidator(PrincipalChain<DateTimeOffset?> chain, int expectedMonth) : IValidator, IRuleDescriptor
{
    public static NullableDateTimeOffsetHaveMonthValidator New(PrincipalChain<DateTimeOffset?> chain, int expectedMonth) =>
