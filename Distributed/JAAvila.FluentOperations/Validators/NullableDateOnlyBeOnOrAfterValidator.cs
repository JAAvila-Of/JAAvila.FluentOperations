...
/// </summary>
internal class NullableDateOnlyBeOnOrAfterValidator(PrincipalChain<DateOnly?> chain, DateOnly expected) : IValidator, IRuleDescriptor
{
    public static NullableDateOnlyBeOnOrAfterValidator New(PrincipalChain<DateOnly?> chain, DateOnly expected) =>
        new(chain, expected);
