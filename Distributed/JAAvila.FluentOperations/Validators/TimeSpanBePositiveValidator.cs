...
/// </summary>
internal class TimeSpanBePositiveValidator(PrincipalChain<TimeSpan> chain)
    : IValidator,
        IRuleDescriptor
{
    public static TimeSpanBePositiveValidator New(PrincipalChain<TimeSpan> chain) => new(chain);
