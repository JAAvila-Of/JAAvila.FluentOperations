...
/// </summary>
internal class TimeSpanBeNegativeValidator(PrincipalChain<TimeSpan> chain)
    : IValidator,
        IRuleDescriptor
{
    public static TimeSpanBeNegativeValidator New(PrincipalChain<TimeSpan> chain) => new(chain);
