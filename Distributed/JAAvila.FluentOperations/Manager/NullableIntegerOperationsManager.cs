        ...
        ITestManager<NullableIntegerOperationsManager, int?>
{
    ...
    /// </summary>
    public NullableIntegerOperationsManager BeOfType<TType>(Reason? reason = null)
    {
    ...
    /// </summary>
    public NullableIntegerOperationsManager BeOfType(Type expected, Reason? reason = null)
    {
        if (!OperationUtils.CheckOperationAllowed(Operations.Common.BeOfType))
            return this;
    ...
    /// </summary>
    public NullableIntegerOperationsManager NotBeOfType<TType>(Reason? reason = null)
    {
    ...
    /// </summary>
    public NullableIntegerOperationsManager NotBeOfType(Type expected, Reason? reason = null)
    {
        if (!OperationUtils.CheckOperationAllowed(Operations.Common.NotBeOfType))
            return this;
