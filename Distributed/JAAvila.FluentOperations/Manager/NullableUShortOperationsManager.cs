        ...
        ITestManager<NullableUShortOperationsManager, ushort?>
{
    ...
    /// </summary>
    public NullableUShortOperationsManager BeGreaterThanOrEqualTo(
        ushort value,
        Reason? reason = null
    )
    {
        ...
        ExecutionEngine<NullableUShortOperationsManager, ushort?>
            .New(this)
            .WithOperation(NullableUShortBeGreaterThanOrEqualToValidator.New(PrincipalChain, value))
            .WithTemplate(
                (template, operation) =>
                    template
                        .WithSubject(PrincipalChain.GetSubject())
    ...
    /// </summary>
    public NullableUShortOperationsManager NotBeInRange(
        ushort min,
        ushort max,
        Reason? reason = null
    )
    ...
    /// </summary>
    public NullableUShortOperationsManager BeOfType<TType>(Reason? reason = null)
    {
    ...
    /// </summary>
    public NullableUShortOperationsManager BeOfType(Type expected, Reason? reason = null)
    {
        if (!OperationUtils.CheckOperationAllowed(Operations.Common.BeOfType))
        {
            return this;
    ...
    /// </summary>
    public NullableUShortOperationsManager NotBeOfType<TType>(Reason? reason = null)
    {
    ...
    /// </summary>
    public NullableUShortOperationsManager NotBeOfType(Type expected, Reason? reason = null)
    {
        if (!OperationUtils.CheckOperationAllowed(Operations.Common.NotBeOfType))
        {
            return this;
