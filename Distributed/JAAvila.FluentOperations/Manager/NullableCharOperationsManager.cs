        ...
        ITestManager<NullableCharOperationsManager, char?>
{
    ...
    public NullableCharOperationsManager BeGreaterThanOrEqualTo(char value, Reason? reason = null)
    {
        ...
        ExecutionEngine<NullableCharOperationsManager, char?>
            .New(this)
            .WithOperation(NullableCharBeGreaterThanOrEqualToValidator.New(PrincipalChain, value))
            .WithTemplate(
                (template, operation) =>
                    template
                        .WithSubject(PrincipalChain.GetSubject())
    ...
    /// </summary>
    public NullableCharOperationsManager BeOfType<TType>(Reason? reason = null)
    {
    ...
    /// </summary>
    public NullableCharOperationsManager BeOfType(Type expected, Reason? reason = null)
    {
        if (!OperationUtils.CheckOperationAllowed(Operations.Common.BeOfType))
        {
            return this;
    ...
    /// </summary>
    public NullableCharOperationsManager NotBeOfType<TType>(Reason? reason = null)
    {
    ...
    /// </summary>
    public NullableCharOperationsManager NotBeOfType(Type expected, Reason? reason = null)
    {
        if (!OperationUtils.CheckOperationAllowed(Operations.Common.NotBeOfType))
        {
            return this;
    ...
    private void ValidateBeOfTypeOperation(Reason? reason, Type? type)
    {
        ExecutionEngine<NullableCharOperationsManager, char?>
            .New(this)
            .WithOperation(ReferenceBeOfTypeValidator<char?>.New(PrincipalChain, type!))
            .WithTemplate(
                (template, operation) =>
                    template
                        .WithSubject(PrincipalChain.GetSubject())
    ...
    private void ValidateNotBeOfTypeOperation(Reason? reason, Type? type)
    {
        ExecutionEngine<NullableCharOperationsManager, char?>
            .New(this)
            .WithOperation(ReferenceNotBeOfTypeValidator<char?>.New(PrincipalChain, type!))
            .WithTemplate(
                (template, operation) =>
                    template
                        .WithSubject(PrincipalChain.GetSubject())
